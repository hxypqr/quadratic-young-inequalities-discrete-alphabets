...
After an earlier version of this paper had been completed, the author learned through private communications with Jos\'e Madrid and Paata Ivanisvili (August 2026) that Jos\'e Madrid, Natanael Alpay, and their respective collaborators had independently obtained solutions to the full binary $r=2$ problem.  The author warmly congratulates them on their independent discoveries.  As far as the author is aware, the results overlap on the binary $r=2$ phase diagram; based on the preliminary information communicated after an initial reading of the present draft, the ternary and general-alphabet results, as well as the transverse $r$-directions established here, appear to be separate.  Their manuscripts are expected to appear on arXiv shortly; formal citations and a detailed comparison will be incorporated into the next revision.
